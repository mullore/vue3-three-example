...
// 导入顶点着色器和片段着色器的源代码
import vertexShader from '../shaders/blackHoleDistortionActive/vertex.glsl?raw';
import fragmentShader from '../shaders/blackHoleDistortionActive/fragment.glsl?raw';
