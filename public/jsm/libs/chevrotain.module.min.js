...
`:case'\r':case'\u2028':case'\u2029':case'\\':case']':throw Error('TBD');default:var u=this.popChar();return{type:'Character',value:i(u)};}},t.prototype.characterClass=function(){var u=[]; var d=!1;for(this.consumeChar('['),this.peekChar(0)==='^'&&(this.consumeChar('^'),d=!0);this.isClassAtom();){var A=this.classAtom(); var _=A.type==='Character';if(_&&this.isRangeDash()){this.consumeChar('-');var g=this.classAtom(); var y=g.type==='Character';if(y){if(g.value<A.value)throw Error('Range out of order in character class');u.push({from:A.value,to:g.value});}else a(A.value,u),u.push(i('-')),a(g.value,u);}else a(A.value,u);}return this.consumeChar(']'),{type:'Set',complement:d,value:u};},t.prototype.classAtom=function(){switch(this.peekChar()){case']':case`
...
`)+`	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_OPTIMIZE`),A=!1;return g;},[]);}),r('ArrayPacking',function(){_=h.packArray(_);}),{emptyGroups:u,patternIdxToConfig:d,charCodeToPatternIdxToConfig:_,hasCustom:i,canBeOptimized:A};}T.analyzeTokenTypes=Za;function Ja(t,e){var r=[]; var n=yn(t);r=r.concat(n.errors);var i=_n(n.valid); var a=i.valid;return r=r.concat(i.errors),r=r.concat(Qa(a)),r=r.concat(gn(a)),r=r.concat(An(a,e)),r=r.concat(Rn(a)),r;}T.validatePatterns=Ja;function Qa(t){var e=[]; var r=h.filter(t,function(n){return h.isRegExp(n[Ae]);});return e=e.concat(On(r)),e=e.concat(In(r)),e=e.concat(kn(r)),e=e.concat(Pn(r)),e=e.concat(Nn(r)),e;}function yn(t){var e=h.filter(t,function(i){return!h.has(i,Ae);}); var r=h.map(e,function(i){return{message:'Token Type: ->'+i.name+'<- missing static \'PATTERN\' property',type:F.LexerDefinitionErrorType.MISSING_PATTERN,tokenTypes:[i]};}); var n=h.difference(t,e);return{errors:r,valid:n};}T.findMissingPatterns=yn;function _n(t){var e=h.filter(t,function(i){var a=i[Ae];return!h.isRegExp(a)&&!h.isFunction(a)&&!h.has(a,'exec')&&!h.isString(a);}); var r=h.map(e,function(i){return{message:'Token Type: ->'+i.name+'<- static \'PATTERN\' can only be a RegExp, a Function matching the {CustomPatternMatcherFunc} type or an Object matching the {ICustomPattern} interface.',type:F.LexerDefinitionErrorType.INVALID_PATTERN,tokenTypes:[i]};}); var n=h.difference(t,e);return{errors:r,valid:n};}T.findInvalidPatterns=_n;var eo=/[^\\][\$]/;function On(t){var e=function(i){hn(a,i);function a(){var o=i!==null&&i.apply(this,arguments)||this;return o.found=!1,o;}return a.prototype.visitEndAnchor=function(o){this.found=!0;},a;}(dn.BaseRegExpVisitor); var r=h.filter(t,function(i){var a=i[Ae];try{var o=vn.getRegExpAst(a); var s=new e;return s.visit(o),s.found;}catch(c){return eo.test(a.source);}}); var n=h.map(r,function(i){return{message:`Unexpected RegExp Anchor Error:
	Token Type: ->`+i.name+`<- static 'PATTERN' cannot contain end of input anchor '$'
	See chevrotain.io/docs/guide/resolving_lexer_errors.html#ANCHORS	for details.`,type:F.LexerDefinitionErrorType.EOI_ANCHOR_FOUND,tokenTypes:[i]};});return n;}T.findEndOfInputAnchor=On;function Nn(t){var e=h.filter(t,function(n){var i=n[Ae];return i.test('');}); var r=h.map(e,function(n){return{message:'Token Type: ->'+n.name+'<- static \'PATTERN\' must not match an empty string',type:F.LexerDefinitionErrorType.EMPTY_MATCH_PATTERN,tokenTypes:[n]};});return r;}T.findEmptyMatchRegExps=Nn;var to=/[^\\[][\^]|^\^/;function In(t){var e=function(i){hn(a,i);function a(){var o=i!==null&&i.apply(this,arguments)||this;return o.found=!1,o;}return a.prototype.visitStartAnchor=function(o){this.found=!0;},a;}(dn.BaseRegExpVisitor); var r=h.filter(t,function(i){var a=i[Ae];try{var o=vn.getRegExpAst(a); var s=new e;return s.visit(o),s.found;}catch(c){return to.test(a.source);}}); var n=h.map(r,function(i){return{message:`Unexpected RegExp Anchor Error:
	Token Type: ->`+i.name+`<- static 'PATTERN' cannot contain start of input anchor '^'
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#ANCHORS	for details.`,type:F.LexerDefinitionErrorType.SOI_ANCHOR_FOUND,tokenTypes:[i]};});return n;}T.findStartOfInputAnchor=In;function kn(t){var e=h.filter(t,function(n){var i=n[Ae];return i instanceof RegExp&&(i.multiline||i.global);}); var r=h.map(e,function(n){return{message:'Token Type: ->'+n.name+'<- static \'PATTERN\' may NOT contain global(\'g\') or multiline(\'m\')',type:F.LexerDefinitionErrorType.UNSUPPORTED_FLAGS_FOUND,tokenTypes:[n]};});return r;}T.findUnsupportedFlags=kn;function Pn(t){var e=[]; var r=h.map(t,function(a){return h.reduce(t,function(o,s){return a.PATTERN.source===s.PATTERN.source&&!h.contains(e,s)&&s.PATTERN!==F.Lexer.NA&&(e.push(s),o.push(s)),o;},[]);});r=h.compact(r);var n=h.filter(r,function(a){return a.length>1;}); var i=h.map(n,function(a){var o=h.map(a,function(c){return c.name;}); var s=h.first(a).PATTERN;return{message:'The same RegExp pattern ->'+s+'<-'+('has been used in all of the following Token Types: '+o.join(', ')+' <-'),type:F.LexerDefinitionErrorType.DUPLICATE_PATTERNS_FOUND,tokenTypes:a};});return i;}T.findDuplicatePatterns=Pn;function gn(t){var e=h.filter(t,function(n){if(!h.has(n,'GROUP'))return!1;var i=n.GROUP;return i!==F.Lexer.SKIPPED&&i!==F.Lexer.NA&&!h.isString(i);}); var r=h.map(e,function(n){return{message:'Token Type: ->'+n.name+'<- static \'GROUP\' can only be Lexer.SKIPPED/Lexer.NA/A String',type:F.LexerDefinitionErrorType.INVALID_GROUP_TYPE_FOUND,tokenTypes:[n]};});return r;}T.findInvalidGroupType=gn;function An(t,e){var r=h.filter(t,function(i){return i.PUSH_MODE!==void 0&&!h.contains(e,i.PUSH_MODE);}); var n=h.map(r,function(i){var a='Token Type: ->'+i.name+'<- static \'PUSH_MODE\' value cannot refer to a Lexer Mode ->'+i.PUSH_MODE+'<-which does not exist';return{message:a,type:F.LexerDefinitionErrorType.PUSH_MODE_DOES_NOT_EXIST,tokenTypes:[i]};});return n;}T.findModesThatDoNotExist=An;function Rn(t){var e=[]; var r=h.reduce(t,function(n,i,a){var o=i.PATTERN;return o===F.Lexer.NA||(h.isString(o)?n.push({str:o,idx:a,tokenType:i}):h.isRegExp(o)&&no(o)&&n.push({str:o.source,idx:a,tokenType:i})),n;},[]);return h.forEach(t,function(n,i){h.forEach(r,function(a){var o=a.str; var s=a.idx; var c=a.tokenType;if(i<s&&ro(o,n.PATTERN)){var f='Token: ->'+c.name+`<- can never be matched.
...
and Non-Terminal names start with a lower case letter.`;return e;},buildAlternationPrefixAmbiguityError:function(t){var e=ye.map(t.prefixPath,function(i){return Ze.tokenLabel(i);}).join(', '); var r=t.alternation.idx===0?'':t.alternation.idx; var n='Ambiguous alternatives: <'+t.ambiguityIndices.join(' ,')+`> due to common lookahead prefix
`+('in <OR'+r+'> inside <'+t.topLevelRule.name+`> Rule,
`)+('<'+e+`> may appears as a prefix path in all these alternatives.
`)+`See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#COMMON_PREFIX
For Further details.`;return n;},buildAlternationAmbiguityError:function(t){var e=ye.map(t.prefixPath,function(i){return Ze.tokenLabel(i);}).join(', '); var r=t.alternation.idx===0?'':t.alternation.idx; var n='Ambiguous Alternatives Detected: <'+t.ambiguityIndices.join(' ,')+'> in <OR'+r+'>'+(' inside <'+t.topLevelRule.name+`> Rule,
`)+('<'+e+`> may appears as a prefix path in all these alternatives.
...
`,type:Yr.REDUNDANT_METHOD,methodName:n});return r;}Y.validateRedundantMethods=Ji;});var ra=R($t=>{'use strict';Object.defineProperty($t,'__esModule',{value:!0});$t.TreeBuilder=void 0;var tt=Hi(); var K=k(); var ta=ea(); var Bs=ce(); var qs=function(){function t(){}return t.prototype.initTreeBuilder=function(e){if(this.CST_STACK=[],this.outputCst=e.outputCst,this.nodeLocationTracking=K.has(e,'nodeLocationTracking')?e.nodeLocationTracking:Bs.DEFAULT_PARSER_CONFIG.nodeLocationTracking,!this.outputCst)this.cstInvocationStateUpdate=K.NOOP,this.cstFinallyStateUpdate=K.NOOP,this.cstPostTerminal=K.NOOP,this.cstPostNonTerminal=K.NOOP,this.cstPostRule=K.NOOP;else if(/full/i.test(this.nodeLocationTracking))this.recoveryEnabled?(this.setNodeLocationFromToken=tt.setNodeLocationFull,this.setNodeLocationFromNode=tt.setNodeLocationFull,this.cstPostRule=K.NOOP,this.setInitialNodeLocation=this.setInitialNodeLocationFullRecovery):(this.setNodeLocationFromToken=K.NOOP,this.setNodeLocationFromNode=K.NOOP,this.cstPostRule=this.cstPostRuleFull,this.setInitialNodeLocation=this.setInitialNodeLocationFullRegular);else if(/onlyOffset/i.test(this.nodeLocationTracking))this.recoveryEnabled?(this.setNodeLocationFromToken=tt.setNodeLocationOnlyOffset,this.setNodeLocationFromNode=tt.setNodeLocationOnlyOffset,this.cstPostRule=K.NOOP,this.setInitialNodeLocation=this.setInitialNodeLocationOnlyOffsetRecovery):(this.setNodeLocationFromToken=K.NOOP,this.setNodeLocationFromNode=K.NOOP,this.cstPostRule=this.cstPostRuleOnlyOffset,this.setInitialNodeLocation=this.setInitialNodeLocationOnlyOffsetRegular);else if(/none/i.test(this.nodeLocationTracking))this.setNodeLocationFromToken=K.NOOP,this.setNodeLocationFromNode=K.NOOP,this.cstPostRule=K.NOOP,this.setInitialNodeLocation=K.NOOP;else throw Error('Invalid <nodeLocationTracking> config option: "'+e.nodeLocationTracking+'"');},t.prototype.setInitialNodeLocationOnlyOffsetRecovery=function(e){e.location={startOffset:NaN,endOffset:NaN};},t.prototype.setInitialNodeLocationOnlyOffsetRegular=function(e){e.location={startOffset:this.LA(1).startOffset,endOffset:NaN};},t.prototype.setInitialNodeLocationFullRecovery=function(e){e.location={startOffset:NaN,startLine:NaN,startColumn:NaN,endOffset:NaN,endLine:NaN,endColumn:NaN};},t.prototype.setInitialNodeLocationFullRegular=function(e){var r=this.LA(1);e.location={startOffset:r.startOffset,startLine:r.startLine,startColumn:r.startColumn,endOffset:NaN,endLine:NaN,endColumn:NaN};},t.prototype.cstInvocationStateUpdate=function(e,r){var n={name:e,children:{}};this.setInitialNodeLocation(n),this.CST_STACK.push(n);},t.prototype.cstFinallyStateUpdate=function(){this.CST_STACK.pop();},t.prototype.cstPostRuleFull=function(e){var r=this.LA(0); var n=e.location;n.startOffset<=r.startOffset?(n.endOffset=r.endOffset,n.endLine=r.endLine,n.endColumn=r.endColumn):(n.startOffset=NaN,n.startLine=NaN,n.startColumn=NaN);},t.prototype.cstPostRuleOnlyOffset=function(e){var r=this.LA(0); var n=e.location;n.startOffset<=r.startOffset?n.endOffset=r.endOffset:n.startOffset=NaN;},t.prototype.cstPostTerminal=function(e,r){var n=this.CST_STACK[this.CST_STACK.length-1];tt.addTerminalToCst(n,r,e),this.setNodeLocationFromToken(n.location,r);},t.prototype.cstPostNonTerminal=function(e,r){var n=this.CST_STACK[this.CST_STACK.length-1];tt.addNoneTerminalToCst(n,r,e),this.setNodeLocationFromNode(n.location,e.location);},t.prototype.getBaseCstVisitorConstructor=function(){if(K.isUndefined(this.baseCstVisitorConstructor)){var e=ta.createBaseSemanticVisitorConstructor(this.className,K.keys(this.gastProductionsCache));return this.baseCstVisitorConstructor=e,e;}return this.baseCstVisitorConstructor;},t.prototype.getBaseCstVisitorConstructorWithDefaults=function(){if(K.isUndefined(this.baseCstVisitorWithDefaultsConstructor)){var e=ta.createBaseVisitorConstructorWithDefaults(this.className,K.keys(this.gastProductionsCache),this.getBaseCstVisitorConstructor());return this.baseCstVisitorWithDefaultsConstructor=e,e;}return this.baseCstVisitorWithDefaultsConstructor;},t.prototype.getLastExplicitRuleShortName=function(){var e=this.RULE_STACK;return e[e.length-1];},t.prototype.getPreviousExplicitRuleShortName=function(){var e=this.RULE_STACK;return e[e.length-2];},t.prototype.getLastExplicitRuleOccurrenceIndex=function(){var e=this.RULE_OCCURRENCE_STACK;return e[e.length-1];},t;}();$t.TreeBuilder=qs;});var ia=R(Zt=>{'use strict';Object.defineProperty(Zt,'__esModule',{value:!0});Zt.LexerAdapter=void 0;var na=ce(); var js=function(){function t(){}return t.prototype.initLexerAdapter=function(){this.tokVector=[],this.tokVectorLength=0,this.currIdx=-1;},Object.defineProperty(t.prototype,'input',{get:function(){return this.tokVector;},set:function(e){if(this.selfAnalysisDone!==!0)throw Error('Missing <performSelfAnalysis> invocation at the end of the Parser\'s constructor.');this.reset(),this.tokVector=e,this.tokVectorLength=e.length;},enumerable:!1,configurable:!0}),t.prototype.SKIP_TOKEN=function(){return this.currIdx<=this.tokVector.length-2?(this.consumeToken(),this.LA(1)):na.END_OF_FILE;},t.prototype.LA=function(e){var r=this.currIdx+e;return r<0||this.tokVectorLength<=r?na.END_OF_FILE:this.tokVector[r];},t.prototype.consumeToken=function(){this.currIdx++;},t.prototype.exportLexerState=function(){return this.currIdx;},t.prototype.importLexerState=function(e){this.currIdx=e;},t.prototype.resetLexerState=function(){this.currIdx=-1;},t.prototype.moveToTerminatedState=function(){this.currIdx=this.tokVector.length-1;},t.prototype.getLexerPosition=function(){return this.exportLexerState();},t;}();Zt.LexerAdapter=js;});var oa=R(Qt=>{'use strict';Object.defineProperty(Qt,'__esModule',{value:!0});Qt.RecognizerApi=void 0;var aa=k(); var Vs=et(); var Xr=ce(); var Ks=mt(); var zs=jr(); var Hs=ne(); var Ys=function(){function t(){}return t.prototype.ACTION=function(e){return e.call(this);},t.prototype.consume=function(e,r,n){return this.consumeInternal(r,e,n);},t.prototype.subrule=function(e,r,n){return this.subruleInternal(r,e,n);},t.prototype.option=function(e,r){return this.optionInternal(r,e);},t.prototype.or=function(e,r){return this.orInternal(r,e);},t.prototype.many=function(e,r){return this.manyInternal(e,r);},t.prototype.atLeastOne=function(e,r){return this.atLeastOneInternal(e,r);},t.prototype.CONSUME=function(e,r){return this.consumeInternal(e,0,r);},t.prototype.CONSUME1=function(e,r){return this.consumeInternal(e,1,r);},t.prototype.CONSUME2=function(e,r){return this.consumeInternal(e,2,r);},t.prototype.CONSUME3=function(e,r){return this.consumeInternal(e,3,r);},t.prototype.CONSUME4=function(e,r){return this.consumeInternal(e,4,r);},t.prototype.CONSUME5=function(e,r){return this.consumeInternal(e,5,r);},t.prototype.CONSUME6=function(e,r){return this.consumeInternal(e,6,r);},t.prototype.CONSUME7=function(e,r){return this.consumeInternal(e,7,r);},t.prototype.CONSUME8=function(e,r){return this.consumeInternal(e,8,r);},t.prototype.CONSUME9=function(e,r){return this.consumeInternal(e,9,r);},t.prototype.SUBRULE=function(e,r){return this.subruleInternal(e,0,r);},t.prototype.SUBRULE1=function(e,r){return this.subruleInternal(e,1,r);},t.prototype.SUBRULE2=function(e,r){return this.subruleInternal(e,2,r);},t.prototype.SUBRULE3=function(e,r){return this.subruleInternal(e,3,r);},t.prototype.SUBRULE4=function(e,r){return this.subruleInternal(e,4,r);},t.prototype.SUBRULE5=function(e,r){return this.subruleInternal(e,5,r);},t.prototype.SUBRULE6=function(e,r){return this.subruleInternal(e,6,r);},t.prototype.SUBRULE7=function(e,r){return this.subruleInternal(e,7,r);},t.prototype.SUBRULE8=function(e,r){return this.subruleInternal(e,8,r);},t.prototype.SUBRULE9=function(e,r){return this.subruleInternal(e,9,r);},t.prototype.OPTION=function(e){return this.optionInternal(e,0);},t.prototype.OPTION1=function(e){return this.optionInternal(e,1);},t.prototype.OPTION2=function(e){return this.optionInternal(e,2);},t.prototype.OPTION3=function(e){return this.optionInternal(e,3);},t.prototype.OPTION4=function(e){return this.optionInternal(e,4);},t.prototype.OPTION5=function(e){return this.optionInternal(e,5);},t.prototype.OPTION6=function(e){return this.optionInternal(e,6);},t.prototype.OPTION7=function(e){return this.optionInternal(e,7);},t.prototype.OPTION8=function(e){return this.optionInternal(e,8);},t.prototype.OPTION9=function(e){return this.optionInternal(e,9);},t.prototype.OR=function(e){return this.orInternal(e,0);},t.prototype.OR1=function(e){return this.orInternal(e,1);},t.prototype.OR2=function(e){return this.orInternal(e,2);},t.prototype.OR3=function(e){return this.orInternal(e,3);},t.prototype.OR4=function(e){return this.orInternal(e,4);},t.prototype.OR5=function(e){return this.orInternal(e,5);},t.prototype.OR6=function(e){return this.orInternal(e,6);},t.prototype.OR7=function(e){return this.orInternal(e,7);},t.prototype.OR8=function(e){return this.orInternal(e,8);},t.prototype.OR9=function(e){return this.orInternal(e,9);},t.prototype.MANY=function(e){this.manyInternal(0,e);},t.prototype.MANY1=function(e){this.manyInternal(1,e);},t.prototype.MANY2=function(e){this.manyInternal(2,e);},t.prototype.MANY3=function(e){this.manyInternal(3,e);},t.prototype.MANY4=function(e){this.manyInternal(4,e);},t.prototype.MANY5=function(e){this.manyInternal(5,e);},t.prototype.MANY6=function(e){this.manyInternal(6,e);},t.prototype.MANY7=function(e){this.manyInternal(7,e);},t.prototype.MANY8=function(e){this.manyInternal(8,e);},t.prototype.MANY9=function(e){this.manyInternal(9,e);},t.prototype.MANY_SEP=function(e){this.manySepFirstInternal(0,e);},t.prototype.MANY_SEP1=function(e){this.manySepFirstInternal(1,e);},t.prototype.MANY_SEP2=function(e){this.manySepFirstInternal(2,e);},t.prototype.MANY_SEP3=function(e){this.manySepFirstInternal(3,e);},t.prototype.MANY_SEP4=function(e){this.manySepFirstInternal(4,e);},t.prototype.MANY_SEP5=function(e){this.manySepFirstInternal(5,e);},t.prototype.MANY_SEP6=function(e){this.manySepFirstInternal(6,e);},t.prototype.MANY_SEP7=function(e){this.manySepFirstInternal(7,e);},t.prototype.MANY_SEP8=function(e){this.manySepFirstInternal(8,e);},t.prototype.MANY_SEP9=function(e){this.manySepFirstInternal(9,e);},t.prototype.AT_LEAST_ONE=function(e){this.atLeastOneInternal(0,e);},t.prototype.AT_LEAST_ONE1=function(e){return this.atLeastOneInternal(1,e);},t.prototype.AT_LEAST_ONE2=function(e){this.atLeastOneInternal(2,e);},t.prototype.AT_LEAST_ONE3=function(e){this.atLeastOneInternal(3,e);},t.prototype.AT_LEAST_ONE4=function(e){this.atLeastOneInternal(4,e);},t.prototype.AT_LEAST_ONE5=function(e){this.atLeastOneInternal(5,e);},t.prototype.AT_LEAST_ONE6=function(e){this.atLeastOneInternal(6,e);},t.prototype.AT_LEAST_ONE7=function(e){this.atLeastOneInternal(7,e);},t.prototype.AT_LEAST_ONE8=function(e){this.atLeastOneInternal(8,e);},t.prototype.AT_LEAST_ONE9=function(e){this.atLeastOneInternal(9,e);},t.prototype.AT_LEAST_ONE_SEP=function(e){this.atLeastOneSepFirstInternal(0,e);},t.prototype.AT_LEAST_ONE_SEP1=function(e){this.atLeastOneSepFirstInternal(1,e);},t.prototype.AT_LEAST_ONE_SEP2=function(e){this.atLeastOneSepFirstInternal(2,e);},t.prototype.AT_LEAST_ONE_SEP3=function(e){this.atLeastOneSepFirstInternal(3,e);},t.prototype.AT_LEAST_ONE_SEP4=function(e){this.atLeastOneSepFirstInternal(4,e);},t.prototype.AT_LEAST_ONE_SEP5=function(e){this.atLeastOneSepFirstInternal(5,e);},t.prototype.AT_LEAST_ONE_SEP6=function(e){this.atLeastOneSepFirstInternal(6,e);},t.prototype.AT_LEAST_ONE_SEP7=function(e){this.atLeastOneSepFirstInternal(7,e);},t.prototype.AT_LEAST_ONE_SEP8=function(e){this.atLeastOneSepFirstInternal(8,e);},t.prototype.AT_LEAST_ONE_SEP9=function(e){this.atLeastOneSepFirstInternal(9,e);},t.prototype.RULE=function(e,r,n){if(n===void 0&&(n=Xr.DEFAULT_RULE_CONFIG),aa.contains(this.definedRulesNames,e)){var i=Ks.defaultGrammarValidatorErrorProvider.buildDuplicateRuleNameError({topLevelRule:e,grammarName:this.className}); var a={message:i,type:Xr.ParserDefinitionErrorType.DUPLICATE_RULE_NAME,ruleName:e};this.definitionErrors.push(a);}this.definedRulesNames.push(e);var o=this.defineRule(e,r,n);return this[e]=o,o;},t.prototype.OVERRIDE_RULE=function(e,r,n){n===void 0&&(n=Xr.DEFAULT_RULE_CONFIG);var i=[];i=i.concat(zs.validateRuleIsOverridden(e,this.definedRulesNames,this.className)),this.definitionErrors=this.definitionErrors.concat(i);var a=this.defineRule(e,r,n);return this[e]=a,a;},t.prototype.BACKTRACK=function(e,r){return function(){this.isBackTrackingStack.push(1);var n=this.saveRecogState();try{return e.apply(this,r),!0;}catch(i){if(Vs.isRecognitionException(i))return!1;throw i;}finally{this.reloadRecogState(n),this.isBackTrackingStack.pop();}};},t.prototype.getGAstProductions=function(){return this.gastProductionsCache;},t.prototype.getSerializedGastProductions=function(){return Hs.serializeGrammar(aa.values(this.gastProductionsCache));},t;}();Qt.RecognizerApi=Ys;});var la=R(Jt=>{'use strict';Object.defineProperty(Jt,'__esModule',{value:!0});Jt.RecognizerEngine=void 0;var q=k(); var le=Yt(); var er=et(); var sa=yt(); var rt=Tt(); var ua=ce(); var Xs=zr(); var ca=Ue(); var Rt=Xe(); var $s=Hr(); var Zs=function(){function t(){}return t.prototype.initRecognizerEngine=function(e,r){if(this.className=$s.classNameFromInstance(this),this.shortRuleNameToFull={},this.fullRuleNameToShort={},this.ruleShortNameIdx=256,this.tokenMatcher=Rt.tokenStructuredMatcherNoCategories,this.definedRulesNames=[],this.tokensMap={},this.isBackTrackingStack=[],this.RULE_STACK=[],this.RULE_OCCURRENCE_STACK=[],this.gastProductionsCache={},q.has(r,'serializedGrammar'))throw Error(`The Parser's configuration can no longer contain a <serializedGrammar> property.
	...
	For Further details.`);}if(q.isArray(e))this.tokensMap=q.reduce(e,function(o,s){return o[s.name]=s,o;},{});else if(q.has(e,'modes')&&q.every(q.flatten(q.values(e.modes)),Rt.isTokenType)){var n=q.flatten(q.values(e.modes)); var i=q.uniq(n);this.tokensMap=q.reduce(i,function(o,s){return o[s.name]=s,o;},{});}else if(q.isObject(e))this.tokensMap=q.cloneObj(e);else throw new Error('<tokensDictionary> argument must be An Array of Token constructors, A dictionary of Token constructors or an IMultiModeLexerDefinition');this.tokensMap.EOF=ca.EOF;var a=q.every(q.values(e),function(o){return q.isEmpty(o.categoryMatches);});this.tokenMatcher=a?Rt.tokenStructuredMatcherNoCategories:Rt.tokenStructuredMatcher,Rt.augmentTokenTypes(q.values(this.tokensMap));},t.prototype.defineRule=function(e,r,n){if(this.selfAnalysisDone)throw Error('Grammar rule <'+e+`> may not be defined after the 'performSelfAnalysis' method has been called'
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);var i=q.has(n,'resyncEnabled')?n.resyncEnabled:ua.DEFAULT_RULE_CONFIG.resyncEnabled; var a=q.has(n,'recoveryValueFunc')?n.recoveryValueFunc:ua.DEFAULT_RULE_CONFIG.recoveryValueFunc; var o=this.ruleShortNameIdx<<le.BITS_FOR_METHOD_TYPE+le.BITS_FOR_OCCURRENCE_IDX;this.ruleShortNameIdx++,this.shortRuleNameToFull[o]=e,this.fullRuleNameToShort[e]=o;function s(p){try{if(this.outputCst===!0){r.apply(this,p);var l=this.CST_STACK[this.CST_STACK.length-1];return this.cstPostRule(l),l;}else return r.apply(this,p);}catch(m){return this.invokeRuleCatch(m,i,a);}finally{this.ruleFinallyStateUpdate();}}var c=function(p,l){return p===void 0&&(p=0),this.ruleInvocationStateUpdate(o,e,p),s.call(this,l);}; var f='ruleName';return c[f]=e,c.originalGrammarAction=r,c;},t.prototype.invokeRuleCatch=function(e,r,n){var i=this.RULE_STACK.length===1; var a=r&&!this.isBackTracking()&&this.recoveryEnabled;if(er.isRecognitionException(e)){var o=e;if(a){var s=this.findReSyncTokenType();if(this.isInCurrentRuleReSyncSet(s))if(o.resyncedTokens=this.reSyncTo(s),this.outputCst){var c=this.CST_STACK[this.CST_STACK.length-1];return c.recoveredNode=!0,c;}else return n();else{if(this.outputCst){var c=this.CST_STACK[this.CST_STACK.length-1];c.recoveredNode=!0,o.partialCstResult=c;}throw o;}}else{if(i)return this.moveToTerminatedState(),n();throw o;}}else throw e;},t.prototype.optionInternal=function(e,r){var n=this.getKeyForAutomaticLookahead(le.OPTION_IDX,r);return this.optionInternalLogic(e,r,n);},t.prototype.optionInternalLogic=function(e,r,n){var i=this; var a=this.getLaFuncFromCache(n); var o; var s;if(e.DEF!==void 0){if(o=e.DEF,s=e.GATE,s!==void 0){var c=a;a=function(){return s.call(i)&&c.call(i);};}}else o=e;if(a.call(this)===!0)return o.call(this);},t.prototype.atLeastOneInternal=function(e,r){var n=this.getKeyForAutomaticLookahead(le.AT_LEAST_ONE_IDX,e);return this.atLeastOneInternalLogic(e,r,n);},t.prototype.atLeastOneInternalLogic=function(e,r,n){var i=this; var a=this.getLaFuncFromCache(n); var o; var s;if(r.DEF!==void 0){if(o=r.DEF,s=r.GATE,s!==void 0){var c=a;a=function(){return s.call(i)&&c.call(i);};}}else o=r;if(a.call(this)===!0)for(var f=this.doSingleRepetition(o);a.call(this)===!0&&f===!0;)f=this.doSingleRepetition(o);else throw this.raiseEarlyExitException(e,sa.PROD_TYPE.REPETITION_MANDATORY,r.ERR_MSG);this.attemptInRepetitionRecovery(this.atLeastOneInternal,[e,r],a,le.AT_LEAST_ONE_IDX,e,rt.NextTerminalAfterAtLeastOneWalker);},t.prototype.atLeastOneSepFirstInternal=function(e,r){var n=this.getKeyForAutomaticLookahead(le.AT_LEAST_ONE_SEP_IDX,e);this.atLeastOneSepFirstInternalLogic(e,r,n);},t.prototype.atLeastOneSepFirstInternalLogic=function(e,r,n){var i=this; var a=r.DEF; var o=r.SEP; var s=this.getLaFuncFromCache(n);if(s.call(this)===!0){a.call(this);for(var c=function(){return i.tokenMatcher(i.LA(1),o);};this.tokenMatcher(this.LA(1),o)===!0;)this.CONSUME(o),a.call(this);this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal,[e,o,c,a,rt.NextTerminalAfterAtLeastOneSepWalker],c,le.AT_LEAST_ONE_SEP_IDX,e,rt.NextTerminalAfterAtLeastOneSepWalker);}else throw this.raiseEarlyExitException(e,sa.PROD_TYPE.REPETITION_MANDATORY_WITH_SEPARATOR,r.ERR_MSG);},t.prototype.manyInternal=function(e,r){var n=this.getKeyForAutomaticLookahead(le.MANY_IDX,e);return this.manyInternalLogic(e,r,n);},t.prototype.manyInternalLogic=function(e,r,n){var i=this; var a=this.getLaFuncFromCache(n); var o; var s;if(r.DEF!==void 0){if(o=r.DEF,s=r.GATE,s!==void 0){var c=a;a=function(){return s.call(i)&&c.call(i);};}}else o=r;for(var f=!0;a.call(this)===!0&&f===!0;)f=this.doSingleRepetition(o);this.attemptInRepetitionRecovery(this.manyInternal,[e,r],a,le.MANY_IDX,e,rt.NextTerminalAfterManyWalker,f);},t.prototype.manySepFirstInternal=function(e,r){var n=this.getKeyForAutomaticLookahead(le.MANY_SEP_IDX,e);this.manySepFirstInternalLogic(e,r,n);},t.prototype.manySepFirstInternalLogic=function(e,r,n){var i=this; var a=r.DEF; var o=r.SEP; var s=this.getLaFuncFromCache(n);if(s.call(this)===!0){a.call(this);for(var c=function(){return i.tokenMatcher(i.LA(1),o);};this.tokenMatcher(this.LA(1),o)===!0;)this.CONSUME(o),a.call(this);this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal,[e,o,c,a,rt.NextTerminalAfterManySepWalker],c,le.MANY_SEP_IDX,e,rt.NextTerminalAfterManySepWalker);}},t.prototype.repetitionSepSecondInternal=function(e,r,n,i,a){for(;n();)this.CONSUME(r),i.call(this);this.attemptInRepetitionRecovery(this.repetitionSepSecondInternal,[e,r,n,i,a],n,le.AT_LEAST_ONE_SEP_IDX,e,a);},t.prototype.doSingleRepetition=function(e){var r=this.getLexerPosition();e.call(this);var n=this.getLexerPosition();return n>r;},t.prototype.orInternal=function(e,r){var n=this.getKeyForAutomaticLookahead(le.OR_IDX,r); var i=q.isArray(e)?e:e.DEF; var a=this.getLaFuncFromCache(n); var o=a.call(this,i);if(o!==void 0){var s=i[o];return s.ALT.call(this);}this.raiseNoAltException(r,e.ERR_MSG);},t.prototype.ruleFinallyStateUpdate=function(){if(this.RULE_STACK.pop(),this.RULE_OCCURRENCE_STACK.pop(),this.cstFinallyStateUpdate(),this.RULE_STACK.length===0&&this.isAtEndOfInput()===!1){var e=this.LA(1); var r=this.errorMessageProvider.buildNotAllInputParsedMessage({firstRedundant:e,ruleName:this.getCurrRuleFullName()});this.SAVE_ERROR(new er.NotAllInputParsedException(r,e));}},t.prototype.subruleInternal=function(e,r,n){var i;try{var a=n!==void 0?n.ARGS:void 0;return i=e.call(this,r,a),this.cstPostNonTerminal(i,n!==void 0&&n.LABEL!==void 0?n.LABEL:e.ruleName),i;}catch(o){this.subruleInternalError(o,n,e.ruleName);}},t.prototype.subruleInternalError=function(e,r,n){throw er.isRecognitionException(e)&&e.partialCstResult!==void 0&&(this.cstPostNonTerminal(e.partialCstResult,r!==void 0&&r.LABEL!==void 0?r.LABEL:n),delete e.partialCstResult),e;},t.prototype.consumeInternal=function(e,r,n){var i;try{var a=this.LA(1);this.tokenMatcher(a,e)===!0?(this.consumeToken(),i=a):this.consumeInternalError(e,a,n);}catch(o){i=this.consumeInternalRecovery(e,r,o);}return this.cstPostTerminal(n!==void 0&&n.LABEL!==void 0?n.LABEL:e.name,i),i;},t.prototype.consumeInternalError=function(e,r,n){var i; var a=this.LA(0);throw n!==void 0&&n.ERR_MSG?i=n.ERR_MSG:i=this.errorMessageProvider.buildMismatchTokenMessage({expected:e,actual:r,previous:a,ruleName:this.getCurrRuleFullName()}),this.SAVE_ERROR(new er.MismatchedTokenException(i,r,a));},t.prototype.consumeInternalRecovery=function(e,r,n){if(this.recoveryEnabled&&n.name==='MismatchedTokenException'&&!this.isBackTracking()){var i=this.getFollowsForInRuleRecovery(e,r);try{return this.tryInRuleRecovery(e,i);}catch(a){throw a.name===Xs.IN_RULE_RECOVERY_EXCEPTION?n:a;}}else throw n;},t.prototype.saveRecogState=function(){var e=this.errors; var r=q.cloneArr(this.RULE_STACK);return{errors:e,lexerState:this.exportLexerState(),RULE_STACK:r,CST_STACK:this.CST_STACK};},t.prototype.reloadRecogState=function(e){this.errors=e.errors,this.importLexerState(e.lexerState),this.RULE_STACK=e.RULE_STACK;},t.prototype.ruleInvocationStateUpdate=function(e,r,n){this.RULE_OCCURRENCE_STACK.push(n),this.RULE_STACK.push(e),this.cstInvocationStateUpdate(r,e);},t.prototype.isBackTracking=function(){return this.isBackTrackingStack.length!==0;},t.prototype.getCurrRuleFullName=function(){var e=this.getLastExplicitRuleShortName();return this.shortRuleNameToFull[e];},t.prototype.shortRuleNameToFullName=function(e){return this.shortRuleNameToFull[e];},t.prototype.isAtEndOfInput=function(){return this.tokenMatcher(this.LA(1),ca.EOF);},t.prototype.reset=function(){this.resetLexerState(),this.isBackTrackingStack=[],this.errors=[],this.RULE_STACK=[],this.CST_STACK=[],this.RULE_OCCURRENCE_STACK=[];},t;}();Jt.RecognizerEngine=Zs;});var pa=R(tr=>{'use strict';Object.defineProperty(tr,'__esModule',{value:!0});tr.ErrorHandler=void 0;var $r=et(); var Zr=k(); var fa=yt(); var Qs=ce(); var Js=function(){function t(){}return t.prototype.initErrorHandler=function(e){this._errors=[],this.errorMessageProvider=Zr.has(e,'errorMessageProvider')?e.errorMessageProvider:Qs.DEFAULT_PARSER_CONFIG.errorMessageProvider;},t.prototype.SAVE_ERROR=function(e){if($r.isRecognitionException(e))return e.context={ruleStack:this.getHumanReadableRuleStack(),ruleOccurrenceStack:Zr.cloneArr(this.RULE_OCCURRENCE_STACK)},this._errors.push(e),e;throw Error('Trying to save an Error which is not a RecognitionException');},Object.defineProperty(t.prototype,'errors',{get:function(){return Zr.cloneArr(this._errors);},set:function(e){this._errors=e;},enumerable:!1,configurable:!0}),t.prototype.raiseEarlyExitException=function(e,r,n){for(var i=this.getCurrRuleFullName(),a=this.getGAstProductions()[i],o=fa.getLookaheadPathsForOptionalProd(e,a,r,this.maxLookahead),s=o[0],c=[],f=1;f<=this.maxLookahead;f++)c.push(this.LA(f));var p=this.errorMessageProvider.buildEarlyExitMessage({expectedIterationPaths:s,actual:c,previous:this.LA(0),customUserDescription:n,ruleName:i});throw this.SAVE_ERROR(new $r.EarlyExitException(p,this.LA(1),this.LA(0)));},t.prototype.raiseNoAltException=function(e,r){for(var n=this.getCurrRuleFullName(),i=this.getGAstProductions()[n],a=fa.getLookaheadPathsForOr(e,i,this.maxLookahead),o=[],s=1;s<=this.maxLookahead;s++)o.push(this.LA(s));var c=this.LA(0); var f=this.errorMessageProvider.buildNoViableAltMessage({expectedPathsPerAlt:a,actual:o,previous:c,customUserDescription:r,ruleName:this.getCurrRuleFullName()});throw this.SAVE_ERROR(new $r.NoViableAltException(f,this.LA(1),c));},t;}();tr.ErrorHandler=Js;});var va=R(rr=>{'use strict';Object.defineProperty(rr,'__esModule',{value:!0});rr.ContentAssist=void 0;var ha=Tt(); var da=k(); var eu=function(){function t(){}return t.prototype.initContentAssist=function(){},t.prototype.computeContentAssist=function(e,r){var n=this.gastProductionsCache[e];if(da.isUndefined(n))throw Error('Rule ->'+e+'<- does not exist in this grammar.');return ha.nextPossibleTokensAfter([n],r,this.tokenMatcher,this.maxLookahead);},t.prototype.getNextPossibleTokenTypes=function(e){var r=da.first(e.ruleStack); var n=this.getGAstProductions(); var i=n[r]; var a=new ha.NextAfterTokenWalker(i,e).startWalking();return a;},t;}();rr.ContentAssist=eu;});var Ra=R(nr=>{'use strict';Object.defineProperty(nr,'__esModule',{value:!0});nr.GastRecorder=void 0;var oe=k(); var Pe=ne(); var tu=ft(); var ma=Xe(); var Ea=Ue(); var ru=ce(); var nu=Yt(); var ir={description:'This Object indicates the Parser is during Recording Phase'};Object.freeze(ir);var Ta=!0; var ya=Math.pow(2,nu.BITS_FOR_OCCURRENCE_IDX)-1; var _a=Ea.createToken({name:'RECORDING_PHASE_TOKEN',pattern:tu.Lexer.NA});ma.augmentTokenTypes([_a]);var ga=Ea.createTokenInstance(_a,`This IToken indicates the Parser is in Recording Phase
